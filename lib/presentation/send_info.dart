...
import 'package:test_ws/domain/sendinfo_model.dart';
import 'package:test_ws/presentation/style/colors.dart';
import 'package:test_ws/presentation/style/font.dart';
import 'package:test_ws/presentation/transactions.dart';

class Sendinfo extends StatelessWidget {
  const Sendinfo({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(create: (context) => SendInfoModel(),child: SubSendInfo(),);
  }
}


class SubSendInfo extends StatelessWidget {
  const SubSendInfo({super.key});
               ...
               Text('Origin details'),
                ...
                SizedBox(height: 8.h,),
                  ...
                  Row(children: [
                    ...
                    SizedBox(height: 8.h,),
                  Row(children: [
                      Text('Tax and Service Charges',style:FontStyle.labelField,),
                       Spacer(),
                    ...
                    SvgPicture.asset('assets/image/divider.svg'),
                     SizedBox(height: 4.h,),
                      Row(children: [
                      Text('Package total',style:FontStyle.labelField,),
                       Spacer(),
        ...
        children: [
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {Navigator.of(context).pop();}, child: Text('Edit package',style: TextStyle(color: colors.main),)),),
                  Spacer(),
                  SizedBox(
                width: 158.w,
                height: 48.h,
                child: ElevatedButton(
                  ...
                  onPressed: () {Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => Transactions()));}, child: Text('Make payment')),),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
      children: [
         Text('19 Ademola Alabi close, lagos ',style:FontStyle.labelField,),
          SizedBox(height: 4.h,),
          Text('+234 70644 80655',style:FontStyle.labelField,),
      ],
    ),);
  }
}