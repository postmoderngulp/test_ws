...
import '../domain/new_password_model.dart';
      ...
      Center(
        child: SizedBox(
            ...
            child: ElevatedButton(
                ...
                onPressed: () =>  model.passwordVal  && model.confirmPasswordVal   ? Navigator.of(context).push(MaterialPageRoute(builder: (context) => SignIn())) : null,
